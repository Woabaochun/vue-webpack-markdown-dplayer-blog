<template>
  <div v-proportion="0.5625" width="100%" style="height:auto;" rel="stylesheet">
    <vue-dplayer :options="options" style="height:100%"></vue-dplayer>
  </div>
</template>
<script>
import Vue from 'vue';
...
const VueDplayer = require("./dist/vue-dplayer.js");
import avatar from '@/assets/HD_logo.png';
...
export default {
  ...
  components: {
    VueDplayer: VueDplayer.vueDplayer
  },
  // computed: {
  //   ...mapState([
  //     'videoOptions'
  ...
  data() {
    return {
      ...
      options: {
        ...
        theme: "#e35885", // 风格颜色，例如播放条，音量条的颜色
        airplay: true, //在 Safari 中启用播放
        loop: false, // 是否自动循环
        lang: "zh-tw", // 语言，'en', 'zh-cn', 'zh-tw'
        screenshot: false, // 是否允许截图（按钮），点击可以自动将截图下载到本地
        hotkey: true, // 是否支持热键，调节音量，播放，暂停等
        preload: "auto", // 自动预加载
        volume: 0.4, // 初始化音量
        logo: avatar, // 在视频左角上打一个logo
        playbackSpeed: [0.5, 0.75, 1, 1.25, 1.5, 2, 3], //可选的播放速度，可自定义
        video: {
          url: this.fileUrl, // 播放视频的路径
          // quality: [
          //   // 设置多个质量的视频
          //   {
          //     name: "高清",
          //     url: this.fileUrl,
          //     type: 'customHls', // 'auto', 'hls', 'flv', 'dash', 'webtorrent', 'normal' 或 其他自定义类型
          //   },
          //   {
          //     name: "标清",
          //     url: "https://www.freecnmove.com/2020/04/a838fc6a/index.m3u8",
          //     type: "customHls",
          //   },
          // ],
          defaultQuality: 0, // 默认是高清
          pic: "", // 视频封面图片
          // thumbnails: this.fileUrl, // 进度条上的缩略图,需要通过dplayer-thumbnails来生成
          type: this.videoType,
          customType: {
  ...
  mounted() {
    document.querySelector(".dplayer-bar-preview").remove();
    document.querySelector(".dplayer-full-in-icon").remove();
  },
  methods: {
...
>>>.dplayer-controller .dplayer-icons-left button {
  height: 70% !important;
  display: flex;
}

>>>.dplayer-controller .dplayer-icons-left button span {
  height: 100%;
  display: flex;
}
...
>>>.dplayer-controller .dplayer-icons-right button {
  font-size: 100% !important;
}

>>>.dplayer-controller .dplayer-icons-right div {
  height: 50% !important;
}


>>>.dplayer-controller .dplayer-icons-right .dplayer-togglebut {
...
>>>.dplayer-controller .dplayer-icons-right {
  right: 0px;
  display: flex;
  align-items: center;
}
...
>>>.dplayer-controller .dplayer-icons .dplayer-setting .dplayer-setting-box.dplayer-setting-box-speed .dplayer-setting-speed-panel .dplayer-setting-speed-item {
  display: block;
...
>>>.dplayer-controller .dplayer-icons .dplayer-setting .dplayer-setting-box.dplayer-setting-box-speed .dplayer-setting-speed-panel .dplayer-setting-speed-item:hover {
...
>>>.markdown-preview .markdown-theme-light {
...
>>>.dplayer-danmaku .dplayer-danmaku-right.dplayer-danmaku-move span {
  height: calc(100% - 4px) !important;
  width: max-content;
  display: flex;
  /*position: absolute;*/
  /*line-height: calc(90% - 4px) !important;*/
  /*font-size: 100% !important;*/
  left: 0;
...
>>>.dplayer-video-wrap {
  ...
  /*background: url(https://img10.360buyimg.com/ddimg/jfs/t1/176340/18/8164/733759/609395e4E2df09db0/80b3d377da26e626.jpg);*/
  /*背景图*/
...
>>>.dplayer-controller .dplayer-ptime {
  height: 12px;
  width: 40px;
  min-width: 40px;
  position: absolute;
...
>>>.dplayer-controller .dplayer-dtime {
  height: 12px;
  width: 40px;
  min-width: 40px;
  position: absolute;
...
>>>.dplayer-icons.dplayer-icons-right .dplayer-setting div {
  height: auto !important;
}

>>>.dplayer-icons.dplayer-icons-right .dplayer-setting .dplayer-setting-item {
  min-height: 30px;
  padding: 5px 10px;
  box-sizing: border-box;
  cursor: pointer;
...
>>>.dplayer-controller .dplayer-comment-setting-box .dplayer-setting-item {
  height: 30px;
  padding: 5px 10px;
  box-sizing: border-box;
  cursor: pointer;
...
>>>.dplayer-controller .dplayer-comment-setting-box .dplayer-setting-item:hover,
  {
  background-color: hsla(0, 0%, 100%, .1)
}

>>>.dplayer-controller .dplayer-comment-setting-box .dplayer-danmaku-bar-wrap {
  display: inline-block
}

>>>.dplayer-controller .dplayer-comment-setting-box .dplayer-danmaku-bar {
  position: relative;
  top: 0px;
  width: 100%;
  height: 100%;
...
>>>.dplayer-controller .dplayer-comment-setting-box .dplayer-danmaku-bar .dplayer-danmaku-bar-inner {
  position: absolute;
  bottom: 0;
  left: 0;
  height: 100%;
...
>>>.dplayer-controller .dplayer-comment-setting-box .dplayer-danmaku-bar .dplayer-danmaku-bar-inner .dplayer-thumb {
  position: absolute;
  top: 0;
  right: 5px;
  margin-top: -4px;
