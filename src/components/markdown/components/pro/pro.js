...
import upLogImg from '../../toolBar/upLogImg.vue';
import upLogVideo from '../../toolBar/upLogVideo.vue';
...
export default {
  ...
  methods: {
    ...
    createEditor() { // 初始化左侧编辑器
      this.$store.state.editor = this.editor = new Codemirror(this.$refs.codemirror, {
  ...
  watch: {
    currentValue() {
      ...
      this.timeoutId = setTimeout(() => {
        ...
        //   breaks: true
        // });
        // this.html = md.render(`__START__${html}__END__`);
        // this.html = compiled.code;
        // this.html = require('marked')(html);
