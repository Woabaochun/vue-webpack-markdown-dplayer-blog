      ...
      <el-col :span="24">
        <el-menu :default-active="type" class="el-menu-demo" mode="horizontal" @select="handleSelect">
          ...
          <el-menu-item index="2">
            <span slot="title">審核<i class="el-menu-item-buttom" /></span>
          </el-menu-item>
            ...
            <el-row class="row-bg blog" :key="blog.id" v-for="blog in blogdata">
              <el-col :span="18" class="blogTitle">
                ...
                <p style="font-size: smaller;">
                  預覽數&nbsp;{{blog.preview_statistics}}<span class="circle-step" />
                  點贊數&nbsp;{{blog.fabulous}}<span class="circle-step" />
                  評論數&nbsp;{{blog.focus_statistics}}
                </p>
              </el-col>
              <el-col :span="6" class="blogEdit">
                <p class="border-width" style="text-align: right;">{{blog.update_date}}</p>
                <p class="border-width">&nbsp;</p>
                <p style="font-size: smaller;text-align: right;" v-if="type != '3'">
...
export default {
  ...
  created() {
    this.$store.commit('setActive', '2-1');
    this.loadTop();
  },
  components: {
