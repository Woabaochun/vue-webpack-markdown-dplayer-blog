                ...
                <div class="demo-type" @click="seeArticle(blog.id)">
                  ...
                  <div class="contentblogimg">
                    <div class="demo-image__lazy" v-proportion="blog.article_type" v-if="blog.article_url">
                      <el-image :key="blog.article_url" :src="blog.article_url" lazy>
                  ...
                  <div class="blogLabels">
                    <div class="blogLabel" v-for="lables in blogLabel(blog.article_tags)">
                      <a>
                        <span style="display: block;">{{lables.text}}</span>
                  ...
                  <div class="buttonblog">
                    ...
                    <div class="blogzan" style="margin-right: 10px;">
                      <span style="display: block;">
...
export default {
  ...
  methods: {
    ...
    loadTop() {
      ...
      this.disabled = true;
      this.ios.selectBlogPageNumber(params).then(res => {
        if (res.data.ret == 0) {
